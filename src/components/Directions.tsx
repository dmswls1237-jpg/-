    ...
    <section id="directions" className="bg-white py-20 text-slate-900 scroll-mt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-slate-500 sm:text-base bg-slate-50/50 p-3 rounded">
        ...
        <div className="mt-12 grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            <div>
              ...
              <div className="mt-3 flex items-center justify-between bg-slate-50 border border-slate-200 px-4 py-3 rounded-sm shadow-xs">
                <span className="text-sm text-slate-700 font-medium">📍 부산광역시 동래구 금강공원로 2, 209호 (2층)</span>
                <span className="text-xs sm:text-sm font-bold text-brand-navy shrink-0 ml-2">온천교 사거리 앞</span>
              </div>
            </div>
            ...
            <div className="mt-4 rounded border border-amber-100 bg-amber-50/50 p-4 text-sm text-slate-700">
              ...
              <p className="mt-1 leading-relaxed">주차는 지하주차장을 이용하실 수 있으며, 온천교 사거리 금강공원로 2 상가 전용 지하주차장 이용 시 무료 주차 지원을 편리하게 제공해 드립니다. 법률 상담 내담을 마치실 때 실시간 무료 주차 확인을 등록해 드립니다.</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6">
            ...
            <div className="rounded-sm border border-slate-250 bg-slate-50 p-6 shadow-sm">
              <h3 className="font-serif text-lg font-bold text-brand-navy mb-4 flex items-center">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="mt-0.5 rounded-full bg-orange-100 p-1 text-orange-700 shrink-0">
                    <span className="text-xs font-bold leading-none px-0.5">1</span>
                  </div>
                  <div className="ml-3">
                    <p className="text-sm font-bold text-slate-800">도시철도 1호선 온천장역 1번 출구</p>
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-bold text-slate-800">온천교사거리 / 온천장역 버스정류장</p>
